package video.api.android.app.liveVideoBroadcaster;
...
public class LiveVideoBroadcasterActivity extends AppCompatActivity {
    ...
    private ServiceConnection mConnection = new ServiceConnection() {
        ...
        public void onServiceConnected(ComponentName className,
                                       IBinder service) {
            // We've bound to LocalService, cast the IBinder and generate LocalService instance
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        rtmpUrl = getIntent().getExtras().getString("rtmpUrl");
    ...
    //This method starts a mTimer and updates the textview to get elapsed time for recording
